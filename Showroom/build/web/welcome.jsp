...
<%@page import="Beans.DatabaseManager"%>
<%@page import="Beans.VehicleBean"%>
<%
    ...
    ArrayList<String> registeredCity = new ArrayList<String>();
    ArrayList<String> registeredYear = new ArrayList<String>();
    ArrayList<String> priceLessThan = new ArrayList<String>();
    ArrayList<String> status = new ArrayList<String>();
    try{
        
     ArrayList<VehicleBean> array = DatabaseManager.getVehicle();
    for(VehicleBean bean : array)
    {
        vehicle.add(bean.getVehicle());
        model.add(bean.getModel());
        color.add(bean.getColor());
        engine.add(bean.getEngine());
        fuel.add(bean.getFuel());
        registeredCity.add(bean.getRegisteredCity());
        registeredYear.add(bean.getRegisteredYear());
        priceLessThan.add(bean.getPrice());
        status.add(bean.getStatus());
    }
%>
<!DOCTYPE html>
<html lang="en">
...
<section class="home" id="home">
    ...
    <form action="SearchVehicles" method="post">
      ...
      <select name="registeredCity">
          <%for(String str : registeredCity){%>
          <option values="<%=str%>"><%  out.println(str); %></option>
          <%}%>
      </select>  
      <br>
      <h2>Registered Year</h2>
      <select name="registeredYeear">
           <%for(String str : registeredYear){%>
          <option values="<%=str%>"><%  out.println(str); %></option>
          <%}%>
      </select>
      <br>
      <h2>Price less than</h2>
      <select name="priceLessThan">
           <%for(String str : priceLessThan){%>
          <option values="<%=str%>"><%  out.println(str); %></option>
          <%}%>
      </select>  
      <br>
